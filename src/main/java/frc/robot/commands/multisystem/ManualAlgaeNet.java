...
public class ManualAlgaeNet extends Command {
  private final AlgaeManipulatorSubsystem algaeManipulatorSubsystem;
  private final ElevatorSubsystem elevatorSubsystem;

  /** Creates a new ManualAlgaeNet. */
  public ManualAlgaeNet(AlgaeManipulatorSubsystem amSubsystem, ElevatorSubsystem eSubsystem) {
  ...
  public void execute() {
    if (this.algaeManipulatorSubsystem.atTarget() && this.elevatorSubsystem.atTarget()) {
      this.algaeManipulatorSubsystem.outtakeAlgaeToNet(0.3);
    } else {
